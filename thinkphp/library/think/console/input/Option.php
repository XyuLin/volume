...
class Option
{
    ...
    public function __construct($name, $shortcut = null, $mode = null, $description = '', $default = null)
    {
        ...
        if (empty($name)) {
            throw new \InvalidArgumentException('An options name cannot be empty.');
        }
        ...
        if (null !== $shortcut) {
            ...
            if (empty($shortcut)) {
                throw new \InvalidArgumentException('An options shortcut cannot be empty.');
            }
        }
        ...
        if ($this->isArray() && !$this->acceptValue()) {
            throw new \InvalidArgumentException('Impossible to have an options mode VALUE_IS_ARRAY if the options does not accept a value.');
        }
    ...
    public function setDefault($default = null)
    {
        ...
        if ($this->isArray()) {
            if (null === $default) {
                ...
                throw new \LogicException('A default value for an array options must be an array.');
            }
        }
