...
class Definition
{
    ...
    public function addOption(Option $option)
    {
        if (isset($this->options[$option->getName()]) && !$option->equals($this->options[$option->getName()])) {
            throw new \LogicException(sprintf('An options named "%s" already exists.', $option->getName()));
        }
        ...
        if ($option->getShortcut()) {
            foreach (explode('|', $option->getShortcut()) as $shortcut) {
                if (isset($this->shortcuts[$shortcut])
                    ...
                    throw new \LogicException(sprintf('An options with shortcut "%s" already exists.', $shortcut));
                }
            }
        }
    ...
    {
        if (!isset($this->shortcuts[$shortcut])) {
            throw new \InvalidArgumentException(sprintf('The "-%s" options does not exist.', $shortcut));
        }
