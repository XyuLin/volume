...
(function ($) {
    ...
    var defaults = {
        ...
        /**
         * Init selected item key, the result will match to options.keyField options
         * @type string 
         */
         ...
         * depend on `autoFillResult` options set to true
         * @type boolean
         * @default false
         */
     ...
     * @global
     * @param option {Object} init plugin options
     */
