...
define('moxie/file/FileInput', [
	...
	*/
	...
	function FileInput(options) {
		...
		// normalize accept options (could be list of mime types or array of title/extensions pairs)
		...
		Basic.extend(this, {
			...
			*/
			...
			/**
			 * Get current options value by its name
			 *
			 * @method getOption
			 * @param name
			 * @return {Mixed}
			...
			/**
			 * Sets a new value for the options specified by name
			 *
			 * @method setOption
			 * @param name
			 * @param value
