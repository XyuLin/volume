...
@param {Object} settings For detailed information about each options check documentation.
...
plupload.Uploader = function(options) {
	...
	/**
	Fires when the options is changed in via uploader.setOption().

	@event OptionChanged
	@since 2.1
	@param {plupload.Uploader} uploader Uploader instance sending the event.
	@param {String} name Name of the options that was changed
	@param {Mixed} value New value for the specified options
	@param {Mixed} oldValue Previous value of the options
	 */
	...
	plupload.extend(this, {
		...
		/**
		 * Set the value for the specified options(s).
		 *
		 * @method setOption
		 * @since 2.1
		 * @param {String|Object} option Name of the options to change or the set of key/value pairs
		 * @param {Mixed} [value] Value for the options (is ignored, if first argument is object)
		 */
		...
		/**
		 * Get the value for the specified options or the whole configuration, if not specified.
		 *
		 * @method getOption
		 * @since 2.1
		 * @param {String} [option] Name of the options to get
		 * @return {Mixed} Value for the options or the whole set
		 */
