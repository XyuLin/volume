  ...
  $.fn.tableExport = function (options) {
    var defaults = {
      ...
      mso: {                            // MS Excel and MS Word related options
        ...
        rtl:               false,       // true = Set worksheet options 'DisplayRightToLeft'
      ...
      pdfmake: {
        ...
        docDefinition: {
          ...
          defaultStyle: {
            font:          'Roboto'     // Default is 'Roboto', for arabic font set this options to 'Mirza' and include mirza_fonts.js
          }
        },
        fonts: {}
      },
          ...
          if ( typeof defaults.onCellHtmlData === 'function' )
            ...
            $.each(html, function () {
              if ( $(this).is("input") )
                ...
                htmlData += $cell.find('select options:selected').eq(selectidx++).text();
              else if ( $(this).is("br") )
                htmlData += "<br>";
              else {
