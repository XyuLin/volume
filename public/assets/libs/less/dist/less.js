...
var parseCopyProperties = [
    // options
    'paths',            // options - unmodified - paths to search for imports on
    'relativeUrls',     // options - whether to adjust URL's to be relative
    'rootpath',         // options - rootpath to append to URL's
    'strictImports',    // options -
    'insecure',         // options - whether to allow imports from insecure ssl hosts
    'dumpLineNumbers',  // options - whether to dump line numbers
    'compress',         // options - whether to compress
    'syncImport',       // options - whether to import synchronously
    'chunkInput',       // options - whether to chunk input. more performant but causes parse issues.
    'mime',             // browser only - mime type for sheet import
    'useFileCache',     // browser only - whether to use the per file session cache
    // context
    'processImports',   // options & context - whether to process imports. if false then imports will not be imported.
...
var evalCopyProperties = [
    ...
    'javascriptEnabled',// options - whether JavaScript is enabled. if undefined, defaults to true
    'pluginManager',  // Used as the plugin manager for the session
...
module.exports = function(SourceMapBuilder) {
    ...
    ParseTree.prototype.toCSS = function(options) {
        ...
        try {
            ...
            if (compress) {
                logger.warn("The compress options has been deprecated. We recommend you use a dedicated css minifier, for instance see less-plugin-clean-css.");
            }
...
module.exports = function() {
    ...
    parserInput.start = function(str, chunkInput, failFunction) {
        ...
        // this is officially deprecated but can be switched on via an options
