...
KISSY.add('dom/attr', function(S, DOM, UA, undefined) {
        ...
        var doc = document,
            ...
            valHooks = {
                option: {
                    get: function(elem) {
                        // 当没有设定 value 时，标准浏览器 options.value === options.text
                        // ie7- 下，没有设定 value 时，options.value === '', 需要用 el.attributes.value 来判断是否有设定 value
 ...
 *    property of an options 在 Safari 4 中已修复。
 *
 */
...
KISSY.add('dom/create', function(S, DOM, UA, undefined) {
        ...
        function fixAttributes(src, dest) {
            ...
            if (nodeName === "object" && !dest.childNodes.length) {
                ...
                // IE6-8 fails to return the selected options to the default selected
